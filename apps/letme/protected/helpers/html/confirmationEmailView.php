...
class ConfirmationEmailView {
    ...
    const text = [
        Languages::russian => [
            ...
            'Здравствуйте',
            'Вы получили это письмо, потому что зарегистрировались в проекте',
            'Чтобы подтвердить свой аккаунт - нажмите кнопку ниже',
            'Подтвердить',
            'Неподтвержденные аккаунты удаляются в течении 3х дней',
            'Обещаем, что не будем присылать других писем',
            'Успешного использования',
            'простой способ создавать ваши заметки',
            'Сделано в'
        ],
        Languages::english => [
            'Confirmation of registration',
            'Hello',
            'You have got this letter, because of registration in project',
            'To confirm your account - push the button below',
            'Confirm',
            'Unconfirmed accounts would be deleted after 3 days of waiting',
            'We promise, that never will send you another letters',
            'Successful use',
            'easy way to create your notes',
            'Made in'
        ],
        Languages::spanish => [
            'Restaurar contraseña',
            'Hola',
            'Tienes esta carta, debido al registro en el proyecto.',
            'Para confirmar su cuenta, presione el botón de abajo',
            'Confirmar',
            'Las cuentas no confirmadas se eliminarán después de 3 días de espera',
            'ETe lo prometemos, que nunca te enviaremos más cartas',
            'Uso exitoso',
            'una forma fácil de crear sus notas',
            'Hecho en'
        ]
    ];
                ...
                <div class="footer" style="clear: both; Margin-top: 10px; text-align: center; width: 100%;">
                    <table border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td class="content-block powered-by"
                                style="font-family:  Helvetica; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                                {$translation[9]} <a href="http://ijn.su"
